...
* Наставник: [Денис {тут должно быть второе изменение} Верхотуров](https://htmlacademy.ru/profile/id56756).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/150755-sedona) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
